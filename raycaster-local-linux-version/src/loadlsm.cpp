...
//
// by skippo, marec 2005, aktualizovane januar 2006
  ...
  if (f!=NULL)
 	{
		...
		while ((data32!=0) && (pocetdir<222)) // ak uz nie je dalsi image dir tak je offset rovny nule
		{
