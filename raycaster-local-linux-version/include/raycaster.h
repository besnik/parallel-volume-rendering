// raycaster.h
// by skip
// trieda CRaycaster - inicializuje a overi nastavenia celeho priestoru a kamery, renderuje
...
typedef struct // tuto strukturu(char*) naplnime datami, ktore potom priradime do textury
{
	unsigned long sirka;
	unsigned long vyska;
	UINT8 *data; // velkost: obrSirka*obrVyska*3 (pre kazdy pixel 3 byte RGB) ak berieme intenzitu tak *1
} Image;
...
public:
	...
	// funkcie
	void initCamRot(); // nastavi parametre pre rotaciu kamery
